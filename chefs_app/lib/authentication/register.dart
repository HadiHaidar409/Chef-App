...
class _RegisterScreenState extends State<RegisterScreen>
{
    ...
    else
      {
        if(passwordController.text == confirmPasswordController.text)
        {
              ...
              && locationController.text.isNotEmpty)
          {
            ...
            fStorage.Reference reference = fStorage.FirebaseStorage.instance.ref().child("chef").child(fileName);
  ...
  {
    FirebaseFirestore.instance.collection("chef").doc(currentUser.uid).set({
      "chefUID": currentUser.uid,
      "chefEmail": currentUser.email,
      "chefName": nameController.text.trim(),
      "chefAvatarUrl": sellerImageUrl,
