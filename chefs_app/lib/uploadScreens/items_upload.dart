...
class _ItemsUploadScreenState extends State<ItemsUploadScreen>
{
      ...
      body: Container(
        ...
        child: Center(
          child: Column(
            ...
            children: [
              const Icon(Icons.shop_two, color: Colors.lightBlue, size: 200.0,),
              ElevatedButton(
                child: const Text(
                  "Add New Items",
                  style: TextStyle(
  ...
  takeImage(mContext)
  {
    return showDialog(
      ...
      {
        return SimpleDialog(
          title: const Text("Add Item Image", style: TextStyle(color: Colors.amber, fontWeight: FontWeight.bold),),
          children: [
            SimpleDialogOption(
