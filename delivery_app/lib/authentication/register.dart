...
class _RegisterScreenState extends State<RegisterScreen>
{
    ...
    else
      {
        if(passwordController.text == confirmPasswordController.text)
        {
              ...
              && locationController.text.isNotEmpty)
          {
            ...
            fStorage.Reference reference = fStorage.FirebaseStorage.instance.ref().child("delivery").child(fileName);
  ...
  {
    FirebaseFirestore.instance.collection("delivery").doc(currentUser.uid).set({
      "deliveryUID": currentUser.uid,
      "deliveryEmail": currentUser.email,
      "deliveryName": nameController.text.trim(),
      "deliveryAvatarUrl": sellerImageUrl,
