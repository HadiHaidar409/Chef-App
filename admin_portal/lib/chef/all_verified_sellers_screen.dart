...
class _AllVerifiedSellersScreenState extends State<AllVerifiedSellersScreen>
{
  ...
  Widget build(BuildContext context)
  {
                      ...
                      leading: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: NetworkImage(allSellers!.docs[i].get("chefAvatarUrl")),
                            fit: BoxFit.fill,
                          ),
                        ),
                      ),
                      title: Text(
                        allSellers!.docs[i].get("chefName"),
                      ),
                      trailing: Row(
                        ...
                        children: [
                          ...
                          Text(
                            allSellers!.docs[i].get("chefEmail"),
    ...
    return Scaffold(
      appBar: SimpleAppBar(title: "All Verified Chefs Accounts",),
      body: Center(
        child: Container(
