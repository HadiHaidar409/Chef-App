...
{
  const AllBlockedDriversScreen({Key? key}) : super(key: key);
...
class _AllBlockedDriversScreenState extends State<AllBlockedDriversScreen>
{
  ...
  Widget build(BuildContext context)
  {
                      ...
                      leading: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: NetworkImage(allSellers!.docs[i].get("deliveryAvatarUrl")),
                            fit: BoxFit.fill,
                          ),
                        ),
                      ),
                      title: Text(
                        allSellers!.docs[i].get("deliveryName"),
                      ),
                      trailing: Row(
                        ...
                        children: [
                          ...
                          Text(
                            allSellers!.docs[i].get("deliveryEmail"),
    ...
    return Scaffold(
      appBar: SimpleAppBar(title: "All Blocked drivers Accounts",),
      body: Center(
        child: Container(
